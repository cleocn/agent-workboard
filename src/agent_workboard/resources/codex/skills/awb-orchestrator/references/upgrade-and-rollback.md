...
`0.3.1b3/v0.3.1b3`, `0.3.1b4/v0.3.1b4`, `0.3.1b5/v0.3.1b5`, and
`0.3.1b6/v0.3.1b6` identities through the frozen `AWB-MIGRATION-GRAPH-v1`
to the exact running `0.3.1b7/v0.3.1b7` wheel, and an exact same-identity
0.3.1b7 no-op when
