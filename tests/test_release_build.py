...
class ReleaseBuildTest(unittest.TestCase):
    def _wheel_from_build(self, repository, destination):
        ...
        prefix = "agent_workboard-0.3.1b10.dist-info"
    ...
    def _release_repository(self, root):
        ...
        subprocess.check_call(["git", "tag", "-a", "v0.3.1b10", "-m", "preview"], cwd=repository)
        return repository
    ...
    def test_one_tagged_build_preserves_identity_and_templates(self):
        with tempfile.TemporaryDirectory() as temporary:
            ...
            self.assertEqual("0.3.1b10", direct_identity["packageVersion"])
            self.assertEqual("v0.3.1b10", direct_identity["sourceTag"])
